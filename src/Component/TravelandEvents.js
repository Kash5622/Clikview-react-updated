...
function TravelsandEvents() {
    const data = [
      ...
      function addPlayBtn(id){
        let divId="teavelAndEvent"+id;
        let divopacityId="travelvideoList"+id;
                      ...
                      return <div key={element.videoId}>
                        <div className="col-md-3 col-sm-6 col-xs-6 keep-padding" data-id="4547" Style="width: 100%; display: inline-block;">
                          <div className="video-list">
                            <div className="video-list-image" id={"travelvideoList"+element.videoId} onMouseEnter={()=>{addPlayBtn(element.videoId)}} onMouseLeave={()=>{removePlayBtn(element.videoId)}}>
                              <Link to="/home2/videodetails/1" data-load="?link1=watch&amp;id=how-to-relax-a-overactive-mind_p7gNF3uhQx7lTgm.html" tabIndex="0">
                                ...
                                <div className="play_hover_btn_svg" id={"teavelAndEvent"+element.videoId} >
...
export default TravelsandEvents