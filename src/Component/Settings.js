...
function Settings() {
    ...
    const [tabStatus,setTabStatus]=useState(searchData);
    useEffect(() => {
        const allIds = ["generalsetting", "profile", "monitization", "password","balance","verification","clikviewsilvertoken","twofactorauthentication","blockeduser","affiliatelink","managesession","myinformation","deleteaccount","avatar"]
        ...
        // setTabStatus(searchData)
        // setSettingsSection(searchData);
    }, [searchData,tabStatus]);
                ...
                <div id="main-container" class="main-content  container " data-logged="true">
                    ...
                    <div id="container_content"><input type="hidden" id="json-data" value="{&quot;title&quot;:&quot;Settings - ClikView - Real Content For You&quot;,&quot;description&quot;:&quot;Clikview is a Video Sharing Platform, Clikview is the best way to start your own video sharing channel! Real Content for you.&quot;,&quot;keyword&quot;:&quot;clikview,video sharing, real content&quot;,&quot;page&quot;:&quot;settings&quot;,&quot;url&quot;:&quot;https:\/\/clikview.com\/settings&quot;,&quot;is_movie&quot;:false}" />
                                ...
                                <div class="col-sm-4">
                                    <div class="settings-sidebar" id="mobi-set-side">
                                        <ul class="list-group scrollmenu" Style="width: 360px;">
                                            <li class="list-group-item active" id='generalsetting' onClick={()=>{setSettingsSection("generalsetting")}}>
						...
						<a href="https://clikview.com/settings/invoice/somac" data-load="?link1=settings&page=invoice&user=somac"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg> Invoices</a>
                                            ...
                                            <li class="list-group-item " id='profile' onClick={()=>{setActiveclass("profile")}}>
                                            ...
                                            <li class="list-group-item " id='monitization' onClick={()=>{setActiveclass("monitization")}}>
                                            ...
                                            <li class="list-group-item " id='password' onClick={()=>{setActiveclass("password")}}>
                                            ...
                                            <li class="list-group-item " id='balance' onClick={()=>{setActiveclass("balance")}}>
                                            ...
                                            <li class="list-group-item " id='avatar' onClick={()=>{setActiveclass("avatar")}}>
                                            ...
                                            <li class="list-group-item " id='verification' onClick={()=>{setActiveclass("verification")}}>
                                            ...
                                            <li class="list-group-item " id='clikviewsilvertoken' onClick={()=>{setActiveclass("clikviewsilvertoken")}}>
                                            ...
                                            <li class="list-group-item " id='twofactorauthentication' onClick={()=>{setActiveclass("twofactorauthentication")}}>
                                            ...
                                            <li class="list-group-item " id='blockeduser' onClick={()=>{setActiveclass("blockeduser")}}>
                                            ...
                                            <li class="list-group-item " id='affiliatelink' onClick={()=>{setActiveclass("affiliatelink")}}>
                                            ...
                                            <li class="list-group-item " id='managesession' onClick={()=>{setActiveclass("managesession")}}>
                                            ...
                                            <li class="list-group-item " id='myinformation' onClick={()=>{setActiveclass("myinformation")}}>
                                            ...
                                            <li class="list-group-item " id='deleteaccount' onClick={()=>{setActiveclass("deleteaccount")}}>
