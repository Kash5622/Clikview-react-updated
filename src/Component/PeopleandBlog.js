...
function PeopleandBlog() {
    const data = [
      ...
      function addPlayBtn(id){
        ...
        let divopacityId="peoplevideoList"+id;
                          ...
                          <div className="video-list">
                            <div className="video-list-image" id={"motivationvideoList"+element.videoId} onMouseEnter={()=>{addPlayBtn(element.videoId)}} onMouseLeave={()=>{removePlayBtn(element.videoId)}}>
                              <Link to="/home2/videodetails/1" data-load="?link1=watch&amp;id=how-to-relax-a-overactive-mind_p7gNF3uhQx7lTgm.html" tabIndex="0">
                                ...
                                <div className="play_hover_btn_svg" id={"peopleAndBlog"+element.videoId} >
