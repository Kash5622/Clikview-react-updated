    ...
    return (
        <div>
            <div class="user-setting-panel page-margin termsofuse pt_shadow col-md-8" Style="margin-bottom: 30px;">
                <h2 class="h2">Procedure for Making Claims of Copyright Infringement</h2>
                ...
                <p>To expedite our ability to process your request, such written notice should be sent to our designated agent as follows:</p>
                <pre>DMCA Complaints
                    Clikview Technologies
                    758 Business centre, Farhidi Heights <br />pobox 8734
                    Fax: +0091734239564
                    Email: dmca@clickview.com</pre>
                <p>If there are many videos to be removed, or you expect to have an ongoing need to remove potentially infringing content from Clikview, we suggest that you email us at&nbsp;<a href="mailto:dmca@clikview.com">dmca@Clikview.com</a>&nbsp;with the subject as "ONGOING DMCA" where we increase the speed at which we are able to remove any infringing content on Clikview and also offer industry-leading content identification tools and personal management for your requests.</p>
                <p>Please note that under Section 512(f) any person who knowingly materially misrepresents that material or activity is infringing may be subject to liability for damages.&nbsp;<strong>Don't make false claims!</strong></p>
                ...
                <p>Claimant information will be published on the Clikview site at anytime.</p>
                <h2 id="counter" class="h2">Counter-Notification</h2>
                <p>If you believe that material you posted has been removed in error, you should send our Copyright Agent, using the contact information listed above, a counter notice that includes the following:</p>
                <ul>
                ...
                <p>Please also be advised that we enforce a policy that provides for the termination in appropriate circumstances of subscribers who are repeat infringers.</p>	</div>
        </div>
    )
}
