        ...
        <div>
            <div className={expandNav ? "main-container shrinkWidth bodyfixed" : "main-container expandWidth"} Style="z-index:-1">
                ...
                {searchOpen ? <MobileSearch /> : ""}
                    ...
                    <div id="container_content"><input type="hidden" id="json-data" value="{&quot;title&quot;:&quot;Create Post - ClikView - Real Content For You&quot;,&quot;description&quot;:&quot;Clikview is a Video Sharing Platform, Clikview is the best way to start your own video sharing channel! Real Content for you.&quot;,&quot;keyword&quot;:&quot;clikview,video sharing, real content&quot;,&quot;page&quot;:&quot;create_post&quot;,&quot;url&quot;:&quot;https:\/\/clikview.com\/create_post&quot;,&quot;is_movie&quot;:false}" />
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form action="" class="form-horizontal user-setting-panel create-post-form pt_shadow pt_forms" id="create_post_form" method="POST">
                                    <div class="pt_page_headr">
                                        <h4 class="page_head"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill-rule="evenodd" fill="currentColor" d="M20,20H4A2,2 0 0,1 2,18V6A2,2 0 0,1 4,4H20A2,2 0 0,1 22,6V18A2,2 0 0,1 20,20M5,13V15H16V13H5M5,9V11H19V9H5Z"></path></svg> Create new post</h4>
                                    </div>
                                    ...
                                    <div class="last-sett-btn">
                                        <button type="submit" id="submit-btn" class="btn btn-main setting-panel-mdbtn">Publish</button>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-2"></div>
...
$(function () {
	...
	$('#create_post_form').ajaxForm({
	    url: 'https://clikview.com/aj/post/create?hash=' + $('.main_session').val(),
	    beforeSend: function() {
	    ...
	    success: function(data) {
	    	...
	    	if (data.status == 200) {
	    		Snackbar.show({text: "<div>Your post has been successfully created.</div>"});
	    		setTimeout(function () {
				...
				Snackbar.show({text: "<div>"+ data.message +"</div>"});
                    ...
                    <input type="hidden" id="main-url" value="https://clikview.com%2Fpaid-videos%3Ftype%3Drented_videos" />
